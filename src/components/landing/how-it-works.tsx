...
const steps = [
  {
    ...
    title: "Cari Topik",
    description:
      "Ketik mata kuliah, topik, atau dosen yang Anda butuhkan. Mesin pencari kami akan menelusuri jutaan materi dari berbagai sumber.",
  ...
  },
  {
    ...
    description:
      "Bandingkan materi dari berbagai provider berdasarkan rating, format, bahasa, dan harga. Filter sesuai kebutuhan Anda.",
  ...
  },
  {
    ...
    title: "Akses & Unduh",
    description:
      "Akses langsung materi yang Anda pilih. Simpan ke koleksi pribadi, unduh untuk offline, atau bagikan dengan teman.",
          ...
          {steps.map((step, i) => (
            <AnimatedItem key={step.title}>
              <div className="relative p-8 rounded-2xl border border-border bg-gradient-to-br transition-all duration-300 hover:shadow-lg hover:-translate-y-1">
                ...
                <div
                  className={`mb-5 flex h-14 w-14 items-center justify-center rounded-xl ${step.iconColor}`}
                >

...
export function CTASection() {
  return (
    <section className="py-20 sm:py-28 relative overflow-hidden">
      <div className="absolute inset-0 bg-gradient-to-br from-blue/10 via-violet/5 to-transparent" />
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-96 h-96 bg-blue/5 rounded-full blur-3xl" />
      ...
      <div className="relative mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 text-center">
        <AnimatedSection>
          ...
          >
            <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full border border-blue/30 bg-blue/5 text-blue text-sm font-medium mb-8">
